...
class ViewController: UIViewController {
    ...
    var filterList: [String] = [
        "CIPointillize", // Mouse horizontal location controls size of dots. Creates a simple pointillist effect using ellipses colored according to pixels in an image. : https://processing.org/examples/pointillism.html
